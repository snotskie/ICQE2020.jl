...
please(means, tv, ["FirstGame", "SecondGame"], "Means Rotation, Subtraction", "means-tv", 1, 1, "No/Pos Confidence Change", "SVD", true)
please(binned, tv, ["FirstGame", "SecondGame"], "Means Rotation, Both Axes", "binned-tv", 1, 1, "No/Pos Confidence Change", "First/Second Game", true)
please(univariate, tv, ["FirstGame", "SecondGame"], "Continuous Variable on X", "univariate-tv", 1, 1, "Confidence Change", "First/Second Game", true)
please(nested, tv, ["FirstGame", "SecondGame"], "Accounting for Nested Structure on X", "nested-tv", 1, 1, "Confidence Change", "First/Second Game", true)

please(means, tv, ["FirstGame"], "Means Rotation, First Game", "means-tv-first-detail", 0.4, 0.4, "No/Pos Confidence Change", "SVD", true)
please(means, tv, ["SecondGame"], "Means Rotation, Second Game", "means-tv-second-detail", 0.4, 0.4, "No/Pos Confidence Change", "SVD", true)
please(means, tv, ["FirstGame", "SecondGame"], "Means Rotation, Subtraction", "means-tv-detail", 0.4, 0.4, "No/Pos Confidence Change", "SVD", true)
please(binned, tv, ["FirstGame", "SecondGame"], "Means Rotation, Both Axes", "binned-tv-detail", 0.4, 0.4, "No/Pos Confidence Change", "First/Second Game", true)
please(univariate, tv, ["FirstGame", "SecondGame"], "Continuous Variable on X", "univariate-tv-detail", 0.4, 0.4, "Confidence Change", "First/Second Game", true)
please(nested, tv, ["FirstGame", "SecondGame"], "Accounting for Nested Structure on X", "nested-tv-detail", 0.4, 0.4, "Confidence Change", "First/Second Game", true)